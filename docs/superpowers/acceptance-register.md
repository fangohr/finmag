...
| D8 | `Simulation` and `sim_with` default to SciPy rather than legacy Sundials | The native factory defaults to Sundials, but the public simulator default was changed during the port. P1.1/P1.2 now validate both backend lifecycles and restart provenance; P1.3 has not yet changed the public default | Restore Sundials as public default in the separately reviewed P1.3 default-change slice | **approved conditionally 2026-07-23 (owner meeting)** |
