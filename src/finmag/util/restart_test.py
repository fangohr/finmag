...
def test_try_to_restart_a_simulation():
    ...
    print("Hm, I would have hoped the next two lines are very similar ...")
    print sim2.m_average, sim2.t
    print sim1.m_average, sim1.t
    print("Out of time here now. I guess we need to plot m(t) to see what is going on ...")
