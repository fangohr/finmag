...
#Addition Hans Fangohr, 4 October. We downloaded
this file using 
wget wget https://bitbucket.org/birkenfeld/ipython-physics/raw/default/physics.py

There is no pip package for this functionality, so it seems 
easiest to just copy the source file in here -- it is only this one
file.
