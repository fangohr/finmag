...
def setup_llg_params_near_one(node_count=5, use_instant=True):
    llg = setup_domain_wall_cobalt(node_count=node_count, A=3.6 * 4e-7 * np.pi, Ms=6.7, K1=4.3, length=1.3, use_instant=use_instant)
    llg.c = 1.23
    llg.gamma = 1.56
    llg.alpha = 2.35
    llg.pins = []
