...
``src/finmag/sim/magnetisation_patterns_test.py`` (formerly
``src/finmag/tests/test_magnetisation_patterns_dolfinx.py``), so
``git diff b5015c5a..HEAD -- src/finmag/sim/magnetisation_patterns_test.py``
