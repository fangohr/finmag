...
set ylabel "ratio"
set yrange [0.0 : 2]
set ytic 0.0, 0.5, 1.5
set format y "%.1f"

set nokey
plot \
    "< paste averages_ref.txt averages.txt" using 1:($2/$6) lc rgbcolor "red", \
    "< paste averages_ref.txt averages.txt" using 1:($3/$7) lc rgbcolor "blue", \
    "< paste averages_ref.txt averages.txt" using 1:($4/$8) lc rgbcolor "green"
