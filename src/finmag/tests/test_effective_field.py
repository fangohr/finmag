...
This file now sits at the master path
``src/finmag/tests/test_effective_field.py`` (formerly
``test_effective_field_dolfinx.py``); both master ancestors listed below are
fully accounted for and have been removed from the tree.
