plot \
    "./averages.txt" using 1:2 title "mx finmag (STT)" with dots lc rgbcolor "blue", \
    "./averages.txt" using 1:3 title "my" with dots lc rgbcolor "red", \
    "./averages.txt" using 1:4 title "mz" with dots lc rgbcolor "green", \
