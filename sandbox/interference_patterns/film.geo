...
solid contact2 = cylinder (62.5, 0, -2.5; 62.5, 0, 1; 2.5)
                    and plane (0, 0, -2.5; 0, 0, -1)
                    and plane (0, 0,  2.5; 0, 0,  1) -maxh = 5.0;

solid aroundcontact1 = cylinder (-62.5, 0, -2.5; -62.5, 0, 2.5; 40)
                    and plane (0, 0, -2.5; 0, 0, -1)
                    and plane (0, 0,  2.5; 0, 0,  1)
                    and not contact1 -maxh = 5.0;

solid aroundcontact2 = cylinder (62.5, 0, -2.5; 62.5, 0, 2.5; 40)
                    and plane (0, 0, -2.5; 0, 0, -1)
                    and plane (0, 0,  2.5; 0, 0,  1)
                    and not contact2 -maxh= 5.0;
